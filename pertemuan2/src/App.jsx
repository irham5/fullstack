...
const INITIAL_TODOS = [
  { id: 1, text: 'Buat folder pertemuan2 di dalam fullstack', done: false, priority: 'high' },
  { id: 2, text: 'Jalankan npm init -y', done: false, priority: 'high' },
  { id: 3, text: 'Buat project React dengan Vite', done: false, priority: 'high' },
  { id: 4, text: 'Implementasi useState pada komponen', done: false, priority: 'medium' },
  { id: 5, text: 'Implementasi useEffect', done: false, priority: 'medium' },
  { id: 6, text: 'Buat komponen dengan Props', done: false, priority: 'medium' },
...
const App = () => {
  ...
  const [nextId, setNextId] = useState(
    () => Math.max(...(JSON.parse(localStorage.getItem('todos_praktikum2') || '[]')
      .map(t => t.id) || [0])) + 1
  );
      ...
      <div style={styles.app}>
        ...
        <div style={styles.header}>
          ...
          <div style={styles.badges}>
            <span style={{ ...styles.badge, background: '#EEEDFE', color: '#3C3489' }}>State</span>
            <span style={{ ...styles.badge, background: '#E1F5EE', color: '#085041' }}>Hooks</span>
            <span style={{ ...styles.badge, background: '#FAECE7', color: '#712B13' }}>Props</span>
          </div>
        </div>
...
const styles = {
  ...
  subtitle: { fontSize: '14px', color: '#888', marginTop: '4px', marginBottom: '8px' },
